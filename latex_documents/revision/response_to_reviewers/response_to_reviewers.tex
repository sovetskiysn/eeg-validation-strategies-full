...
cross-subject, cross-session, cross-task and cross-dataset
...
(participant or documented session) before assigning windows to folds. Every
window from a recording unit remains on one side of a split. The revised
Methods reserve cross-session validation for data with documented independent
recording sessions.
