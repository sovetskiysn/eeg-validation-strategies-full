...
All three figures have been redrawn to fit within the PLOS width limit of
7.5~inches, at 300~dpi, with all in-figure text at 8--12~pt, without removing
any panel, column or row: the transfer matrix still reports all eleven
source--target columns for five decoders, and the remaining two figures still
compare all five decoders across every validation protocol. \texttt{Fig1.tif},
\texttt{Fig2.tif} and \texttt{Fig3.tif} are supplied as LZW-compressed TIFF at
300~dpi within the required dimensions.
